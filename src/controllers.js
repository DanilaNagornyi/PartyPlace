...
const userSignup = async(req, res) => {
  const {firstName, lastName, email, pass: plainPass, group, year, avatar, phoneNumber, locationTown} = req.body;
  console.log(req.body);
  if (firstName && lastName && email && plainPass && group && year && avatar && phoneNumber && locationTown) {
